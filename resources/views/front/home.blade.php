    ...
    <div class="container">
        ...
        <div class="row property__gallery">
                ...
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="{{asset('front-assets/img/product/product-1.jpg')}}">
                        ...
                        <ul class="product__hover">
                            <li><a href="{{asset('front-assets/img/product/product-1.jpg')}}" class="image-popup"><span class="arrow_expand"></span></a></li>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix men">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="{{asset('front-assets/img/product/product-2.jpg')}}">
                        <ul class="product__hover">
                            <li><a href="{{asset('front-assets/img/product/product-2.jpg')}}" class="image-popup"><span class="arrow_expand"></span></a></li>
                            <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                            <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                        </ul>
                    </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix accessories">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="{{asset('front-assets/img/product/product-3.jpg')}}">
                        <div class="label stockout">out of stock</div>
                        <ul class="product__hover">
                            <li><a href="{{asset('front-assets/img/product/product-3.jpg')}}" class="image-popup"><span class="arrow_expand"></span></a></li>
                            <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                            <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                        </ul>
                    </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix cosmetic">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="{{asset('front-assets/img/product/product-4.jpg')}}">
                        <ul class="product__hover">
                            <li><a href="{{asset('front-assets/img/product/product-4.jpg')}}" class="image-popup"><span class="arrow_expand"></span></a></li>
                            <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                            <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                        </ul>
                    </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix kid">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="{{asset('front-assets/img/product/product-5.jpg')}}">
                        <ul class="product__hover">
                            <li><a href="{{asset('front-assets/img/product/product-5.jpg')}}" class="image-popup"><span class="arrow_expand"></span></a></li>
                            <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                            <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                        </ul>
                    </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix women men kid accessories cosmetic">
                <div class="product__item sale">
                    <div class="product__item__pic set-bg" data-setbg="{{asset('front-assets/img/product/product-6.jpg')}}">
                        <div class="label sale">Sale</div>
                        <ul class="product__hover">
                            <li><a href="{{asset('front-assets/img/product/product-6.jpg')}}" class="image-popup"><span class="arrow_expand"></span></a></li>
                            <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                            <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                        </ul>
                    </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix women men kid accessories cosmetic">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="{{asset('front-assets/img/product/product-7.jpg')}}">
                        <ul class="product__hover">
                            <li><a href="{{asset('front-assets/img/product/product-7.jpg')}}" class="image-popup"><span class="arrow_expand"></span></a></li>
                            <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                            <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                        </ul>
                    </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix women men kid accessories cosmetic">
                <div class="product__item sale">
                    <div class="product__item__pic set-bg" data-setbg="{{asset('front-assets/img/product/product-8.jpg')}}">
                        <div class="label">Sale</div>
                        <ul class="product__hover">
                            <li><a href="{{asset('front-assets/img/product/product-8.jpg')}}" class="image-popup"><span class="arrow_expand"></span></a></li>
                            <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                            <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                        </ul>
                    </div>
...
<section class="banner set-bg" data-setbg="{{asset('front-assets/img/banner/banner-1.jpg')}}">
    <div class="container">
        <div class="row">
        ...
        <div class="row">
                ...
                <div class="trend__content">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="{{asset('front-assets/img/trend/ht-1.jpg')}}" alt="">
                        </div>
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="{{asset('front-assets/img/trend/ht-2.jpg')}}" alt="">
                        </div>
                        <div class="trend__item__text">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="{{asset('front-assets/img/trend/ht-3.jpg')}}" alt="">
                        </div>
                        <div class="trend__item__text">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="trend__content">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="{{asset('front-assets/img/trend/bs-1.jpg')}}" alt="">
                        </div>
                        <div class="trend__item__text">
                            <h6>Cotton T-Shirt</h6>
                            <div class="rating">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="{{asset('front-assets/img/trend/bs-2.jpg')}}" alt="">
                        </div>
                        <div class="trend__item__text">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="{{asset('front-assets/img/trend/bs-3.jpg')}}" alt="">
                        </div>
                        <div class="trend__item__text">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="trend__content">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="{{asset('front-assets/img/trend/f-1.jpg')}}" alt="">
                        </div>
                        <div class="trend__item__text">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="{{asset('front-assets/img/trend/f-2.jpg')}}" alt="">
                        </div>
                        <div class="trend__item__text">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="{{asset('front-assets/img/trend/f-3.jpg')}}" alt="">
                        </div>
                        <div class="trend__item__text">
